...
router.register(r'organization-git-connections', views.OrganizationGitConnectionViewSet, basename='organization-git-connections')
router.register(r'personal-git-connections', views.PersonalGitConnectionViewSet, basename='personal-git-connections')
