...
REAPER_PIDFILE="${REAPER_PIDFILE:-/tmp/projecteverflow-no-cursor-attribution-reaper.pid}"
REAPER_LOG="${REAPER_LOG:-/tmp/projecteverflow-no-cursor-attribution-reaper.log}"
