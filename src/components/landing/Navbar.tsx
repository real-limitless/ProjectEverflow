    ...
    >
      <nav className="container mx-auto flex items-center justify-between px-4 py-3 lg:px-8">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <a
            href={`${GITHUB_URL}/blob/Development-Everflow/README.md`}
            target="_blank"
          ...
          <Button size="sm" className="bg-primary text-primary-foreground hover:bg-primary/90" asChild>
            <a href="#screenshots">See product</a>
          </Button>
        </div>
      ...
      {isMobileOpen && (
        <div className="glass-strong animate-fade-in border-t lg:hidden">
          <div className="container mx-auto flex flex-col gap-2 px-4 py-4">
            ...
            <Button className="bg-primary text-primary-foreground" asChild>
              <a href="#screenshots" onClick={() => setIsMobileOpen(false)}>
                See product
              </a>
            </Button>
          </div>
