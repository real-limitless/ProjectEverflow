...
Where Everflow sits versus adjacent products (OpenHands, Coder, Dify, Dust, Cursor/Devin, Hugging Face Spaces, and others), and the P0–P2 gaps that follow from that, is tracked in [issue #20](https://github.com/real-limitless/ProjectEverflow/issues/20) and [`docs/competitive-feature-gap.md`](docs/competitive-feature-gap.md).
